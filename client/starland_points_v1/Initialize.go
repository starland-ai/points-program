...
func (inst *Initialize) SetAuthority(authority ag_solanago.PublicKey) *Initialize {
	inst.Authority = &authority
	return inst
}

// SetUserPointsAccount sets the "userPoints" account.
func (inst *Initialize) SetUserPointsAccount(userPoints ag_solanago.PublicKey) *Initialize {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(userPoints).WRITE().SIGNER()
	return inst
}

// GetUserPointsAccount gets the "userPoints" account.
func (inst *Initialize) GetUserPointsAccount() *ag_solanago.AccountMeta {
